...
# ================================================================
MODEL_PATH = "segformer_ecu"  # Folder, w którym zapisał się model z 3_train.py
BATCH_SIZE = 4
# ================================================================
...
def ewaluuj_model():
    ...
    with torch.no_grad():
        for i, batch in enumerate(test_loader):
            ...
            # Upsampling predykcji do rozmiaru maski
            ...
            # Liczenie metryk dla każdego obrazu w batchu
